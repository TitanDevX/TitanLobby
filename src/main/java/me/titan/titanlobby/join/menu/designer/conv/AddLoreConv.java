...
public class AddLoreConv extends SimpleConversation {
	...
	public AddLoreConv(MenuButton btn, JoinMenuConfig confg){
		this.btn = btn;
		this.confg = confg;
	}
	...
	public class prompt extends SimplePrompt{
		...
		protected @Nullable Prompt acceptValidatedInput(@NotNull ConversationContext context, @NotNull String input) {
			...
			btn.getLores().addAll(result);
			Common.tellConversing(context.getForWhom(), "&aYou have successfully added lore(s) line(s).");
